...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__page_mineSweeperScreen__ = __webpack_require__(25);



__WEBPACK_IMPORTED_MODULE_1_react_dom__["render"](__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2__page_mineSweeperScreen__["a" /* MineSweeperScreen */], null)), document.getElementById("main"));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__component_mineSweeperGrid__ = __webpack_require__(26);


class MineSweeperScreen extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    constructor(props) {
        super(props);
        this.generateCells = () => {
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { style: styles.container }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { style: styles.content }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { style: styles.header }, __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { style: styles.score }, this.state.score), __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { style: styles.restart, onClick: this.restart }, this.state.frozen ? this.state.won ? "😎" : "😬" : "🙂"), __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { style: styles.score }, Math.floor(this.state.timer / 1000))), __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1__component_mineSweeperGrid__["a" /* MineSweeperGrid */], { width: width, height: height, cells: cells, onMineActivated: this.freeze, frozen: this.state.frozen, onFlagAdded: this.decreaseScore, onFlagRemoved: this.increaseScore, onCellActivated: this.decreaseRemainingCells })));
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = MineSweeperScreen;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__cell__ = __webpack_require__(27);


class MineSweeperGrid extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.cells = [];
        this.getCells = () => {
        ...
        this.activateCell = (i, j, activatedIndexes) => {
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { style: { display: "flex", flexDirection: "column" } }, cells.map((row, rowIndex) => __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { style: { display: "flex" }, key: rowIndex }, row.map((cell, index) => __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1__cell__["a" /* Cell */], { ref: c => this.cells[rowIndex * width + index] = c, key: index, frozen: frozen, value: cell, onMineActivated: onMineActivated, onFlagAdded: onFlagAdded, onFlagRemoved: onFlagRemoved, onCellActivated: activatedIndexes => this.activateCell(rowIndex, index, activatedIndexes) })))));
    }
}
/* harmony export (immutable) */ __webpack_exports__["a"] = MineSweeperGrid;
...
var CellStatus;
(function (CellStatus) {
    CellStatus[CellStatus["HIDDEN"] = 0] = "HIDDEN";
    CellStatus[CellStatus["FLAGGED"] = 1] = "FLAGGED";
    CellStatus[CellStatus["ACTIVATED"] = 2] = "ACTIVATED";
})(CellStatus || (CellStatus = {}));
class Cell extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor(props) {
        super(props);
        this.renderCellContent = () => {
            switch (this.state.status) {
                ...
                case CellStatus.FLAGGED:
                    return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null, "\uD83C\uDFF4\uDB40\uDC67\uDB40\uDC62\uDB40\uDC65\uDB40\uDC6E\uDB40\uDC67\uDB40\uDC7F");
                case CellStatus.ACTIVATED:
                    return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", null, this.props.value === 10 ? "💣" : this.props.value || "");
            }
        };
        this.setStatus = e => {
        ...
        this.activateCell = activatedIndexes => {
            if (this.props.frozen) {
                return;
            }
            const currentStatus = this.state.status;
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { style: Object.assign({}, styles.cell, { backgroundColor: status === CellStatus.ACTIVATED ? "#a0a0a0" : "#e2e2e2" }), onClick: () => this.activateCell([]), onContextMenu: this.setStatus }, this.renderCellContent());
    }
